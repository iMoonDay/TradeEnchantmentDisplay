...
public final class TradeEnchantmentDisplayFabric implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        LiteralArgumentBuilder<FabricClientCommandSource> builder = ClientCommandManager.literal(ModCommands.ROOT);
        for (Command command : ModCommands.getCommands()) {
            builder.then(ClientCommandManager.literal(command.getName()).executes(context -> command.execute()));
        }
